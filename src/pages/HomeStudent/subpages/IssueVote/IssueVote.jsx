...
export const IssueVote = ({backButton}) => {
    ...
    const [studentCreated, setStudentCreated] = useState(null);//save if the student has been created in the BC
    const [student_Voted, setStudent_Voted] = useState(null);//save if the student has voted
    const [closeVotation, setCloseVotation] = useState(null);//save if the votation has been closed because the contract course has expired
    const [show_Buttons, setShow_Buttons] = useState(null);//if we select a course, show the confirmation buttons
...
////////////////////////////////////////////// uesEffects //////////////////////////////////////////
    ...
    },[closeVotation, timeContract, student_Voted]);
    ...
    <>
      ...
      {closeVotation ?
        ...
        <>
          ...
          <br />
          <Title textTitle={"Course selected: "+nameCourse+'\n'+"  Id Course: "+idCourse} classType="dataCourse-issuing-vote" />
          <br />
